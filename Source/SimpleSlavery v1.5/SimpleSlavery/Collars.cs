...
namespace SimpleSlaveryCollars
{
    ...
    public class SlaveCollar_Explosive : SlaveApparel
    {
        ...
        public void GoBoom()
        {
            ...
            var destroyNeck = new DamageInfo(DamageDefOf.Bomb, 100f, 100f, -1f, this, Wearer.RaceProps.body.AllParts.Find(part => part.def == SS_BodyPartDefOf.Neck));
    ...
    public class SlaveCollar_Electric : SlaveApparel
    {
        ...
        public void Zap()
        {
            var zap = new DamageInfo(DamageDefOf.Burn, 1f, 100f, -1f, this, Wearer.RaceProps.body.AllParts.Find(part => part.def == SS_BodyPartDefOf.Neck));
            var zap2 = new DamageInfo(DamageDefOf.Stun, 1f, 100f, -1f, this, Wearer.RaceProps.body.AllParts.Find(part => part.def == SS_BodyPartDefOf.Neck));
    ...
    public class SlaveCollar_Crypto : SlaveApparel
    {
        ...
        public void CryptoStasis()
        {
            ...
            if (Wearer.mindState.mentalStateHandler.CurStateDef != SS_MentalStateDefOf.CryptoStasis)
                Wearer.mindState.mentalStateHandler.TryStartMentalState(SS_MentalStateDefOf.CryptoStasis, reason: null, forceWake: true, causedByMood: false, otherPawn: null, transitionSilently: true);
            if (Rand.Value < 0.33f)
            {
